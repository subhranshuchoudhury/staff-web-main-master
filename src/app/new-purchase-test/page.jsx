...
export default function page() {
  ...
  //   if (imageFile) {
  //     data.append("invoices", imageFile);
  //   }
  ...
  return (
    <>
      ...
      <dialog
        ...
        // You can open the modal programmatically like this:
                  ...
                  <>
                    ...
                    <div className="card bg-base-200/50 border border-base-300">
                      <div className="card-body p-4 md:p-6">
                        <h3 className="card-title mb-4">Invoice Summary</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-2 text-sm">
                          <div className="flex flex-col">
                            ...
                            <span className="font-bold text-base">
                              {apiResponse.invoice_no}
                            </span>
                          </div>
                          <div className="flex flex-col">
                            <span className="text-base-content/60">Date</span>
                            <span className="font-bold text-base">
                              {apiResponse.invoice_date}
                            </span>
                          </div>
                          <div className="flex flex-col">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="font-bold text-primary text-lg">
                              ₹{apiResponse.grand_total.toLocaleString("en-IN")}
                            </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      {apiResponse.items?.map((item, idx) => {
                        return (
                          <div
                            key={idx}
                          ...
                          >
                            <div className="card-body p-5">
                              ...
                              <div className="card-actions justify-end mt-4">
                                <button
                                  onClick={() =>
                                    handleAddtoPurchase(item, apiResponse)
                                  }
                                  className="btn btn-primary btn-sm"
                                  // disabled={addedItems.has(item.part_no)} // optional: disable if already added
                                >
                                  {addedItems.has(item.part_no)
                                    ? "Add Again"
                                    : "Add to Purchase"}
          ...
          <div className="modal-action mt-0">
            {apiResponse || apiError ? (
              ...
              <form method="dialog" className="flex-grow">
                {" "}
                {/* This form helps close the modal on cancel */}
